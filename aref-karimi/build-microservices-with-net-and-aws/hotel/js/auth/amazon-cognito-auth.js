          ...
          _createClass(CognitoAuth, [
            {
              ...
              value: function getCognitoConstants() {
                var CognitoConstants = {
                  ...
                  POST: "POST",
                  PARAMETERERROR:
                    "The parameters: App client Id, App web domain" +
            ...
            },
            {
              ...
              value: function getSession() {
                ...
                if (!this.compareSets(tokenScopesInputSet, cachedScopesSet)) {
                  ...
                  !this.signInUserSession.getRefreshToken() ||
            ...
            },
            {
              ...
              value: function getCodeQueryParameter(map) {
                ...
                if (map.has(this.getCognitoConstants().CODE)) {
                  ...
                  var url = this.getCognitoConstants().DOMAIN_SCHEME.concat(
                    this.getCognitoConstants().COLONDOUBLESLASH,
                    this.getAppWebDomain(),
                    this.getCognitoConstants().SLASH,
                    this.getCognitoConstants().DOMAIN_PATH_TOKEN
                  );
            ...
            },
            {
              ...
              value: function compareSets(set1, set2) {
                ...
                try {
                  for (
                    var _iterator = set1[Symbol.iterator](), _step;
            ...
            },
            {
              ...
              value: function getHostName(url) {
                ...
                if (
                  match != null &&
                  match.length > 2 &&
                  _typeof(match[2]) === this.getCognitoConstants().STRINGTYPE &&
                  match[2].length > 0
                ) {
                  return match[2];
                }
            ...
            },
            {
              ...
              value: function createCORSRequest(method, url) {
                ...
                if (this.getCognitoConstants().WITHCREDENTIALS in xhr) {
                  ...
                  (typeof XDomainRequest === "undefined" ? "undefined" : _typeof(XDomainRequest)) !==
                  this.getCognitoConstants().UNDEFINED
                ) {
              ...
              value: function onSuccessRefreshToken(jsonData) {
                ...
                if (Object.prototype.hasOwnProperty.call(jsonDataObject, this.getCognitoConstants().ERROR)) {
                  ...
                  if (Object.prototype.hasOwnProperty.call(jsonDataObject, this.getCognitoConstants().ACCESSTOKEN)) {
                    this.signInUserSession.setAccessToken(
                      new _CognitoAccessToken2.default(jsonDataObject.access_token)
                    );
                  }
                  this.cacheTokensScopes();
                  this.userhandler.onSuccess(this.signInUserSession);
            ...
            },
            {
              ...
              value: function onSuccessExchangeForToken(jsonData) {
                ...
                if (Object.prototype.hasOwnProperty.call(jsonDataObject, this.getCognitoConstants().REFRESHTOKEN)) {
                  this.signInUserSession.setRefreshToken(
                    new _CognitoRefreshToken2.default(jsonDataObject.refresh_token)
                  );
                } else {
                  this.signInUserSession.setRefreshToken(refreshToken);
                }
              ...
              value: function getFQDNSignIn() {
                if (this.state == null) {
                  this.state = this.generateRandomString(
                    this.getCognitoConstants().STATELENGTH,
                ...
                if (userContextData) {
                  userContextDataParam =
                    this.getCognitoConstants().AMPERSAND +
                    this.getCognitoConstants().DOMAIN_QUERY_PARAM_USERCONTEXTDATA +
                    this.getCognitoConstants().EQUALSIGN +
                    this.getUserContextData();
                }

                // Build the complete web domain to launch the login screen
                var uri = this.getCognitoConstants().DOMAIN_SCHEME.concat(
                  this.getCognitoConstants().COLONDOUBLESLASH,
                  this.getAppWebDomain(),
                  this.getCognitoConstants().SLASH,
                  this.getCognitoConstants().DOMAIN_PATH_SIGNIN,
                  this.getCognitoConstants().QUESTIONMARK,
                  this.getCognitoConstants().DOMAIN_QUERY_PARAM_REDIRECT_URI,
                  this.getCognitoConstants().EQUALSIGN,
                  encodeURIComponent(this.RedirectUriSignIn),
                  this.getCognitoConstants().AMPERSAND,
                  ...
                  this.getClientId(),
                  this.getCognitoConstants().AMPERSAND,
                  this.getCognitoConstants().STATE,
                  this.getCognitoConstants().EQUALSIGN,
                  this.state,
                  this.getCognitoConstants().AMPERSAND,
                  this.getCognitoConstants().SCOPE,
                  this.getCognitoConstants().EQUALSIGN,
                  tokenScopesString,
            ...
            },
            {
              ...
              value: function getFQDNSignOut() {
                var uri = this.getCognitoConstants().DOMAIN_SCHEME.concat(
                  ...
                  this.getAppWebDomain(),
                  this.getCognitoConstants().SLASH,
                  this.getCognitoConstants().DOMAIN_PATH_SIGNOUT,
                  this.getCognitoConstants().QUESTIONMARK,
                  this.getCognitoConstants().DOMAIN_QUERY_PARAM_SIGNOUT_URI,
                  this.getCognitoConstants().EQUALSIGN,
                  encodeURIComponent(this.RedirectUriSignOut),
                  this.getCognitoConstants().AMPERSAND,
                  this.getCognitoConstants().CLIENT_ID,
                  this.getCognitoConstants().EQUALSIGN,
                  this.getClientId()
          ...
          _createClass(DateHelper, [
            {
              ...
              value: function getNowString() {
                ...
                var dateNow =
                  weekDay + " " + month + " " + day + " " + hours + ":" + minutes + ":" + seconds + " UTC " + year;
